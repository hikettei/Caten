...
(defclass TensorRelay (AType)
  ((shape :accessor tensor-relay-shape :initarg :shape :initform nil :type list)
   ...
   (vectorize :accessor tensor-relay-vectorize :initarg :vectorize :initform 0)
...
(defun make-tensor-relay (shape stride dtype views &key (value nil) (permute nil) (orig-shape nil) (depend-idx-list nil) (iterspace nil) (vectorize nil))
  ...
  (make-instance 'TensorRelay :shape shape :stride stride :dtype dtype :views views :value value :nrank (length shape) :permute permute :orig-shape orig-shape :depend-idx-list depend-idx-list :iterspace iterspace :vectorize vectorize))
