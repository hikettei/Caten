...
(defpackage :caten/air
  ...
  (:export #:Graph #:FastGraph #:make-graph #:copy-graph #:graph-p #:graph-seen #:graph-outputs #:Graph-nodes #:id->value #:id->users #:remnode #:verify-graph
	   #:insert-nodes #:->graph #:->fast-graph #:%graph-nodes-table #:graph-weakly-connected-p #:->graph-with-tpsort #:tpsort-graph #:make-node-pointing-to-nth #:with-cache-io-degree)
