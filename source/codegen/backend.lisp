...
(defmacro define-backend (name buffer-class runtime-class auto-scheduler-class is-jit-p)
  "
```
(define-backend name buffer-class runtime-class auto-scheduler-class is-jit-p)
```
