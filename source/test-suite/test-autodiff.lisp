...
(macrolet ((def (opname lisp-name torch-name schedule shape &key axis use-linspace)
  ...
  (def sum2d-axis !sum torch.sum 5 (10 10) :axis 1)
  (def mean2d-axis !mean torch.mean 5 (10 10) :axis 1)
  (def sum3d-axis !sum torch.sum 5 (10 10 10) :axis 1)
  (def mean3d-axis !mean torch.mean 5 (10 10 10) :axis 1)
