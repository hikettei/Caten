(defpackage :caten/utilities/documentation
  (:use :cl)
  (:export
   #:build-docs
   #:define-page)
  ...
  (:export
   ...
   #:doc/generic
   #:doc/variable))
(in-package :caten/utilities/documentation)
...
(defun build-docs ()
  (maphash
   #'(lambda (pathname builder)
       (caten/utilities/logger:print-info "Building: ~a" pathname)
   ...
   *pages*)
  (caten/utilities/logger:print-info "Done"))
