(defpackage :caten/utilities/dtype
  (:documentation "")
  (:use :cl :alexandria)
  (:export
   #:dtype-t
...
(in-package :caten/utilities/dtype)
...
(declaim (inline caten/utilities/dtype:encode-float64 caten/utilities/dtype:decode-float32 caten/utilities/dtype:encode-float64 caten/utilities/dtype:decode-float64))
